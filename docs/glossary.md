...
| Term | Meaning |
|------|---------|
| **Nirgun** | "Without attributes" -- the formless, attributeless aspect of the divine. The GGS is overwhelmingly nirgun in orientation (42.25% of lines). |
| **Sagun** | "With attributes" -- the divine as manifest in forms, names, and incarnations. Sagun narrative appears in only 0.51% of GGS lines. |
| **Naam** | "The Name" / "The Divine Name" -- a central concept in Sikh theology referring to the immanent presence of the divine in all creation. Not a specific word but a state of consciousness. |
| **Waheguru** | "Wonderful Lord" -- the most commonly used name for God in modern Sikh practice. Appears 171 times in the GGS, far less than Hari (9,341). |
| **Hari** | The most frequent divine name in the GGS (9,341 occurrences). In Sikh context, Hari refers to the formless divine, not the Hindu deity Vishnu. |
| **Ram** | Appears 2,019 times. In the GGS, Ram functions as a nirgun name for the formless divine, not as a reference to the Ramayana prince Ramchandra. |
...
| **Haumai** | "Ego/Self-centeredness" -- the primary spiritual obstacle in Sikh theology. The root of the Five Thieves. |
...
| **Perso-Arabic register** | Vocabulary derived from Persian and Arabic (Allah, Khuda, Noor, Qazi, Dargah). |
...
| **Density** | Entity count divided by token count for a line. A continuous score in [0, 1] measuring how concentrated a particular register is in a given line. |
